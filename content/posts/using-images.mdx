...
<div align="center">
<Image alt="Example post OG image, showing the website name, logo, post title, description and author" src="/posts/using-images.png" loading="lazy" height={252} width={480} data-img-embed/>
</div>
...
<div align="center">
<Image alt="Example site OG image, showing the website name, logo and description" src="/ogImage.png" loading="lazy" height={252} width={480} data-img-embed/>
</div>
