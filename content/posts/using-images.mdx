...
import ogImageUsingImages from '../../public/ogExampleUsingImages.png'
import ogImage from '../../public/ogImageExample.png'
...
<div align="center">
<Image alt="Nordlys preview" src={preview} loading="lazy" height={252} width={480} data-img-embed/>
</div>
...
<div align="center">
<Image alt="Nordlys preview" src={preview} loading="lazy" height={252} width={480} data-img-embed data-action="zoom"/>
</div>
...
<div align="center">
<Image alt="Example post OG image, showing the website name, logo, post title, description and author" src={ogImageUsingImages} loading="lazy" height={252} width={480} data-img-embed data-action="zoom"/>
</div>
...
<div align="center">
<Image alt="Example site OG image, showing the website name, logo and description" src={ogImage} loading="lazy" height={252} width={480} data-img-embed data-action="zoom"/>
</div>
