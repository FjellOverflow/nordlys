...
_Nordlys_ is a personal blog template built with [Astro](https://astro.build/), a static site generator (SSG). To get more familiar with SSG and Astro, make sure to take a look at the [documentation](https://docs.astro.build/en/getting-started/) first.
...
To create our own content for the website, you will need to create and edit files in the project. The recommended way of doing that, is using [Visual Studio Code](https://code.visualstudio.com/) (or one of its derivatives). To use some recommended extensions that play well with the template, open the _Extensions_ tab in VS Code and type `@recommended`; VS Code will display those extensions and you can install them from there.
