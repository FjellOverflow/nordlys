...
> Nordlys uses the `@tailwindcss/typography` plugin to style authored content. Below is a sample post taken directly from [tailwindcss-typography](https://github.com/tailwindlabs/tailwindcss-typography) demonstrating the various styles available.
