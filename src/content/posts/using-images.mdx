...
![Nordlys logo, a drawing of two gray mountains with green northern lights in the background](@/assets/logo.svg)
...
<Image alt="Nordlys logo, a drawing of two gray mountains with green northern lights in the background" src={logo} loading="lazy"/>
