...
<div align="center">
<Image class="border-[1px] border-accent rounded-md" alt="[Example post OG" src="/posts/using-images.png" loading="lazy" height={252} width={480}/>
</div>
...
<div align="center">
<Image class="border-[1px] border-accent rounded-md" alt="[Example site OG" src="/ogImage.png" loading="lazy" height={252} width={480}/>
</div>
